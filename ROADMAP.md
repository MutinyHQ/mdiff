...
This document tracks feature ideas, prioritized issues, and the rationale behind them. It draws from competitive analysis of tools like **critique**, **tuicr**, **acre**, **difi**, **deff**, **git-review**, **Kaleidoscope**, **lazygit**, **fzf**, and patterns from RLHF/human feedback research.
...
#### 11. Review Checklist Templates (NEW)
...
#### 12. Diff Complexity Indicators (NEW)
...
#### 13. Inline AI Suggestions (Agent-in-the-Loop)
...
#### 14. Multi-Worktree Comparison View
...
#### 15. Bookmark System for Large Reviews
...
#### 16. Word-Level (Intra-Line) Diff Highlighting
...
#### 18. Smart Review Ordering (Auto-Sort Files by Priority)
...
**Scope**: Add sort modes toggled with `O`: by change size (largest first), by file type priority (tests -> impl -> config -> docs), by annotation density, by review status. Show sort indicator in navigator header. Remember sort preference in config. Can integrate with complexity indicators (#12) for content-aware sorting.
**Competitive reference**: GitHub PR file ordering, Reviewable smart ordering, IntelliJ change list grouping.

#### 19. Glob-Based File Filtering
...
#### 20. Diff Heatmap Mode (Change Density Visualization)
...
#### 21. Mouse Support for Navigation (NEW)
...
#### 22. Watch Mode with Auto-Refresh (NEW)
...
#### 24. Diff Snapshot / Time Travel (NEW)
...
#### 34. External Editor Integration for Long Annotations
...
- **deff** (NEW): Rust TUI for side-by-side git diff review, posted on HN March 2026. Very early (8 commits). Has per-file navigation, syntax highlighting, vim motions. No annotation or agent features -- validates the space but not a competitive threat.
...
- Active learning principles (selecting the most informative data points for human labeling) directly apply to deciding which hunks need review. This informed the Diff Complexity Indicators feature (#12).
